...
config.secret["conf1"]="c1";
config.secret["conf2"]="c2";
config.secret["conf3"]="c3";
config.secret["ai0"]="abc123";
config.secret["ai1"]="a1";
config.secret["ai2"]="a2";
config.secret["ai3"]="a3";
...
console.log(toRemove+" Terminated")//disconnected
...
function handleControlMessage(socket,data)
{
  ...
  o=JSON.parse(data);
  switch(o["status"]){
    case "register": clients[o["id"]]=socket;console.log(o["id"]);break;//client to log
